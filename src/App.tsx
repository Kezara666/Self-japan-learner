...
type Question = KanaQuestion | KanjiQuestion;
    ...
    return (
      <div className="mx-auto flex min-h-screen max-w-[520px] flex-col gap-6 px-4 pb-8 pt-5 sm:px-5 sm:pt-8">
        <header>
          ...
          <p className="m-0 text-[0.95rem] text-slate-400">Hiragana, katakana, and JLPT N5 kanji</p>
        </header>
          ...
          {choiceLabels.map(({ key, label, num }) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={latinChoice ? "font-sans break-words" : "font-zen break-words"}
